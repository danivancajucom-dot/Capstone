...
import "./faculty-view-cancelled-reservation.css";

function FacultyViewCancelledReservation() {
  ...
  if (!reservation) {
    return (
      <div className="faculty-cancelled-reservation-room">
  ...
  return (
    <div className="faculty-cancelled-reservation-room">
      <i
        className="fa-solid fa-arrow-left faculty-cancelled-back-arrow"
        onClick={() => navigate(-1)}
        style={{ cursor: "pointer", fontSize: "20px", marginBottom: "12px" }}
      ></i>

      <div className="faculty-white-box-cancelled">
        <h2 className="faculty-cancelled-title">Cancelled Reservation Details</h2>

        <div className="faculty-cancelled-info-grid">
          {/* ─── Requester ────────────────────────────────────────── */}
          <div className="faculty-cancelled-info-box">
            <h3 className="faculty-cancelled-info-box-title">
              <i className="fa-solid fa-user"></i> Requester
            </h3>
            <div className="faculty-cancelled-info-box-content">
              <p>
          ...
          <div className="faculty-cancelled-info-box">
            ...
            <div className="faculty-cancelled-info-box-content">
              <p>
                ...
                <span className="faculty-cancelled-status-badge cancelled">Cancelled</span>
              </p>
              <p>
      ...
      <div className="faculty-cancelled-footer">
        <button
          className="faculty-cancelled-back-btn"
...
export default FacultyViewCancelledReservation;