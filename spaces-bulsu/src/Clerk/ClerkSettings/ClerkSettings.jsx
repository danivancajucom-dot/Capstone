...
export default function ClerkSettings() {
  ...
  return (
    <>
              ...
              <div className="fs-card">
                ...
                <div className="fs-step-actions">
                  <button
                    ...
                    onClick={() => { setPwStep("password"); setPwCode(Array(CODE_LENGTH).fill("")); }}
                    disabled={busy}
                  >
                    Cancel
                  </button>
      ...
      {/* ── DELETE ACCOUNT — 2-STEP "GRABIHAN" ─────────────────── */}
      {showDeleteModal && (
        <div className="fs-modal-overlay" onClick={() => !busy && closeModals()}>
          ...
          <div className="info-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            {activeInfoModal === "faq" && (
              <>
                ...
                <p className="info-modal-subtitle">Quick answers to the most common questions.</p>
