...
function ClerkViewReservationDenied() {
  ...
  if (!reservation) {
    return (
      <div className="clerk-denied-reservation-room">
  ...
  return (
    <div className="clerk-denied-reservation-room">
      <i
        className="fa-solid fa-arrow-left clerk-denied-back-arrow"
        onClick={() => navigate(-1)}
        style={{ cursor: "pointer", fontSize: "20px", marginBottom: "12px" }}
      ></i>

      <div className="clerk-denied-white-box">
        <h2 className="clerk-denied-title">Denied Reservation Details</h2>

        {/* ─── Denial Reason (highlighted) ───────────────────────── */}
        <div className="clerk-denied-reason-box">
          <i className="fa-solid fa-circle-exclamation clerk-denied-reason-icon"></i>
          <div>
        ...
        <div className="clerk-denied-info-grid">
          {/* ─── Faculty / Requester ────────────────────────────── */}
          <div className="clerk-denied-info-box">
            <h3 className="clerk-denied-info-box-title">
              <i className="fa-solid fa-user"></i> Requester
            </h3>
            <div className="clerk-denied-info-box-content">
              <p>
          ...
          <div className="clerk-denied-info-box">
            ...
            <div className="clerk-denied-info-box-content">
              <p>
                ...
                <span className="clerk-denied-status-badge denied">Denied</span>
              </p>
              <p>
      ...
      <div className="clerk-denied-footer">
        <button
          className="clerk-denied-back-btn"
