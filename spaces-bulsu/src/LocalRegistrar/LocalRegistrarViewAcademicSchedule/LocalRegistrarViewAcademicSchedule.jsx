      ...
      <div className="white-box-rooms">
        <div className="building-floor-filter">
          <div className="filter-group building-group">
            ...
            {/* BUILDING PICKER */}
            <div className="lrvs-buildingpicker">
              <button
                type="button"
                className={`lrvs-building-trigger ${showBuildingPicker ? "open" : ""}`}
                onClick={() => { setBuildingSearch(""); setShowBuildingPicker((v) => !v); }}
              >
                <i className="fa-solid fa-building"></i>
                <span className="lrvs-building-trigger-text">
                  {selectedBuilding || "All Buildings"}
                </span>
                <i className={`fa-solid fa-chevron-down lrvs-building-caret ${showBuildingPicker ? "open" : ""}`}></i>
              </button>

              {showBuildingPicker && (
                <>
                  <div className="lrvs-picker-clickaway" onClick={() => setShowBuildingPicker(false)}></div>
                  <div className="lrvs-building-popover">
                    <span className="lrvs-popover-arrow"></span>

                    <div className="lrvs-search-wrap">
                      <i className="fa-solid fa-magnifying-glass"></i>
                      <input type="text" className="lrvs-search" placeholder="Search building..."
                        value={buildingSearch} onChange={(e) => setBuildingSearch(e.target.value)} autoFocus />
                      {buildingSearch && (
                        <button type="button" className="lrvs-search-clear" onClick={() => setBuildingSearch("")}>
                          <i className="fa-solid fa-xmark"></i>
                        </button>
                      )}
                    </div>

                    <div className="lrvs-building-list">
                      {filteredBuildings.length === 0 ? (
                        <div className="lrvs-picker-empty">
                        ...
                        filteredBuildings.map((b) => {
                          ...
                          return (
                            <button type="button" key={b}
                              className={`lrvs-building-option ${isActive ? "is-active" : ""}`}
                              onClick={() => {
                              ...
                              <div className="lrvs-building-option-icon">
                                <i className="fa-solid fa-building"></i>
                              </div>
                              <span className="lrvs-building-option-name">{b}</span>
                              {isActive && <i className="fa-solid fa-circle-check lrvs-building-option-check"></i>}
                            </button>
                          );
                        })
                      )}
        ...
        <div className="lr-room-cards">
          {loading ? (
            ...
            <div className="room-empty">
              ...
              <p>No rooms match the selected filters. Try clearing filters.</p>
            </div>
          ) : (
          ...
          <div className="filter-panel">
            ...
            <div className="filter-panel-body">
              ...
              <div className="filter-group">
                ...
                <div className="lrvs-datepicker">
                  <button type="button"
                    className={`lrvs-date-trigger ${showDatePicker ? "open" : ""}`}
                    onClick={() => {
                    ...
                    <i className={`fa-solid fa-chevron-down lrvs-date-caret ${showDatePicker ? "open" : ""}`}></i>
                  </button>

                  {showDatePicker && (
                    <>
                      <div className="lrvs-picker-clickaway" onClick={() => setShowDatePicker(false)}></div>
                      <div className="lrvs-date-popover">
                        <span className="lrvs-popover-arrow"></span>

                        <div className="lrvs-cal-header">
                          <button type="button" className="lrvs-cal-nav" onClick={() =>
                            setCalendarCursor((c) => {
                              const m = c.month - 1;
                          ...
                          <span className="lrvs-cal-title">{MONTH_NAMES[calendarCursor.month]} {calendarCursor.year}</span>
                          <button type="button" className="lrvs-cal-nav" onClick={() =>
                            setCalendarCursor((c) => {
                              const m = c.month + 1;
                        ...
                        <div className="lrvs-cal-weekdays">
                          {WEEKDAY_LABELS.map((w) => <span key={w}>{w}</span>)}
                        </div>

                        <div className="lrvs-cal-grid">
